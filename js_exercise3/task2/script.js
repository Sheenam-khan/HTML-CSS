...
function searching() {
    ...
    search.forEach(element => {
        ...
        content += `<p>${element.slice(0, element.indexOf(search))}<span class="highlight">${element.substr(element.indexOf(search), search.length)}</span>${element.slice(element.indexOf(search.value) + search.length, )}</p>`; 
    });
...
//     }
||||||| parent of 2aebe16... js_exercise3 tasks
=======
...
//         listElement.appendChild(listItem);
//     }
>>>>>>> 2aebe169cdc6f541e2f541c53c44839cd57be9c2
